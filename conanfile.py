...
class HeatMapConan(ConanFile):
    """Class to package HeatMap plugin using conan
    ...
    name = "Heatmap"
    description = (
        "A plugin for data heat-maps in the high-dimensional plugin system (HDPS)."
    )
    topics = ("hdps", "plugin", "heatmap", "data visualization")
    url = "https://github.com/hdps/HeatMap"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/HeatMap")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The HeatMap build expects the HDPS package to be in this install dir
